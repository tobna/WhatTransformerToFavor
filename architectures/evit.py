...
class EViT(nn.Module, ResizingInterface):
    ...
    def set_image_res(self, res):
        ...
        self.pos_embed = nn.Parameter(
            resize_pos_embed(self.pos_embed, pos_embed_new, num_tokens=self.num_tokens).contiguous()
        )
...
__all__ = [
    ...
    "evit_small_patch16",
    "evit_base_patch16",
    "evit_tiny_patch16_fuse",
    "evit_small_patch16_fuse",
    "evit_base_patch16_fuse",
]
