...
class ConvRelPosEnc(nn.Module):
    ...
    def __init__(self, Ch, h, window):
        ...
        for cur_window, cur_head_split in window.items():
            ...
            padding_size = (
                cur_window + (cur_window - 1) * (dilation - 1)
            ) // 2  # Determine padding size. Ref: https://discuss.pytorch.org/t/how-to-keep-the-shape-of-input-and-output-same-when-dilation-conv/14338
            cur_conv = nn.Conv2d(
                cur_head_split * Ch,
                cur_head_split * Ch,
...
class CoaT(nn.Module, ResizingInterface):
    """CoaT class."""
