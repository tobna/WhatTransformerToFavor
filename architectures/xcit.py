...
class LPI(nn.Module):
    ...
    def __init__(
        self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.0, kernel_size=3
    ):
        super().__init__()
...
class XCiT(nn.Module, ResizingInterface):
    ...
    def __init__(
        ...
        self.patch_embed = ConvPatchEmbed(
            img_size=img_size, embed_dim=embed_dim, patch_size=patch_size, in_chans=in_chans
        )
        self.patch_size = patch_size
